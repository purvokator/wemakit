...
const PricingSection = () => {
  const pricingPlans = [
    ...
    },
    {
      ...
      features: ['Unlimited users','Unlimited stock photos','Pause or cancel anytime','Custom workflow solutions', 'Dedicated support', 'Enterprise-grade services'],
      variant: 'light'
    }
  ];
...
// Add colors, typography, spacing, and styles here...
const colors = {
  primary: '#000000',
  secondary: '#FFFFFF',
  accent: '#E7E8E9',
...
const styles = {
  ...
  outlineButton: {
    ...
    border: `1px solid ${colors.accent}`,  // Ganti dengan warna border dari light card
    color: colors.grey  // Ganti dengan warna text yang serasi
  }
};
