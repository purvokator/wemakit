    ...
    <div style={{ background: 'black', color: 'white', padding: '50px 0' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 30, fontWeight: 600, margin: 0 }}>
            Hitting roadblocks in your pursuit of a design soulmate? Let’s{' '}
            <span style={{ fontStyle: 'italic', fontFamily: 'Behind The Nineties' }}>Wemakit</span>{' '}
            solved it
          </p>
          <button style={{
            marginTop: 24,
